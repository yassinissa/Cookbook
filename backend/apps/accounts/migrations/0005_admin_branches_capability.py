"""Re-sync the Capability catalogue after adding `admin.branches`
(Administrator via '*' only — matches admin.users/admin.roles)."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_menu_publish_capability'),
    ]
