"""Re-sync the Capability catalogue after adding `admin.prep_kitchens`
(Administrator via '*' only — matches admin.branches)."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0007_edit_roles_get_costing_view'),
    ]
